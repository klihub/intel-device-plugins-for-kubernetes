...
var metricsResource = schema.GroupVersionResource{Group: "cpupools.intel.com", Version: "v1alpha1", Resource: "metrics"}

var metricsKind = schema.GroupVersionKind{Group: "cpupools.intel.com", Version: "v1alpha1", Kind: "Metric"}
...
func (c *FakeMetrics) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(metricsResource, c.ns, listOptions)
