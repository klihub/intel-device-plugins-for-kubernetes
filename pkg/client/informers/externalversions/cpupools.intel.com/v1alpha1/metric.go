...
import (
	...
	cpupoolsintelcomv1alpha1 "github.com/intel/intel-device-plugins-for-kubernetes/pkg/apis/cpupools.intel.com/v1alpha1"
	...
	v1alpha1 "github.com/intel/intel-device-plugins-for-kubernetes/pkg/client/listers/cpupools.intel.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CpupoolsV1alpha1().Metrics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CpupoolsV1alpha1().Metrics(namespace).Watch(options)
			},
		},
		&cpupoolsintelcomv1alpha1.Metric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *metricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cpupoolsintelcomv1alpha1.Metric{}, f.defaultInformer)
}
